...
import project.ii.flowx.module.user.dto.UserPresenceEvent;
...
public class UserPresenceService {
    ...
    private void broadcastPresenceUpdate(UUID userId, String status) {
        try {
    ...
    public void refreshUserPresence(UUID userId) {
